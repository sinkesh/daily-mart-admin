...
const QueryList: React.FC = () => {
    ...
    const columns = [
        ...
        },
        {
            key: "email",
            label: "Email",
            render: (value: string, row: UserTypes) => row.email || "-",
        },
        {
            key: "phone_number",
            label: "Phone Number",
            render: (value: string, row: UserTypes) => row.phone_number || "-",
        },
        {
            key: "subject",
            label: "Subject",
            render: (value: string, row: any) => row.subject || "-",
        },
        {
            key: "query",
            label: "Query",
            render: (value: string, row: any) => row.query || "-",
        },
        {
            key: "status",
            label: "Status",
